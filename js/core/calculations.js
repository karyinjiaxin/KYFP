  ...
  function gwa4Projection(annualPremium, choice, expectedReturnPct, years, premiumYears, dividendYieldPct) {
    ...
    for (var yearIndex = 0; yearIndex <= years; yearIndex++) {
      if (yearIndex === 0) {
        ...
        var y0FeePct = (payYears <= 1) ? lowFeePct : (gwa4PolicyFeePct(choice, 1) / 100);
      ...
      var policyFeePct = (policyYearCompleting >= payYears - 1) ? lowFeePct : (gwa4PolicyFeePct(choice, policyYearCompleting) / 100);
